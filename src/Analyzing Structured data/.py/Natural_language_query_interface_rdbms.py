...
if __name__ == '__main__':
  """
  for Script Invoking from command line with argparse ex- cd Natural_Language_Query_Interface_RDBMS.ipynb.py '/content/drive/MyDrive/Colab Notebooks/DataScience+GPT/Data/structured_data/games.db'
  question example -- Break down game sales in Europe by the platform!
  """
