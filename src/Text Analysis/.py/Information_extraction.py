...
if __name__ == '__main__':
    """
for the Script invoking from command line ex- cd  Information_Extraction.py "/content/drive/MyDrive/Colab Notebooks/DataScience+GPT/Data/textanalysis/biographies.csv" ['person name', ' city of birth', ' date of birth']
    """
